...
urlpatterns = [
    path('esctop-escolha/', login_required(v.EsctopClienteDecision.as_view()), name='esctop_cliente_decision'),
    ...
    path('dashboard-esctop/', login_required(v.EsctopDashboard.as_view()), name='esctop_dashboard'),
]