...
class Avalista(models.Model):
    ...
    fiador_rg                  = models.CharField("RG",max_length=20, blank=False, null=True)
    ...
    fiador_cep                 = models.CharField("CEP", max_length=10, blank=False, null=True)
    ...
    def get_absolute_url(self):
        return reverse_lazy('avalista:esctop_avalista_detail', kwargs={'pk': self.pk})
