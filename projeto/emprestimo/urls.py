...
urlpatterns = [
    ...
    path('<int:pk>/emprestimo_contrato_cnpj+emprestimo_promissoria/', login_required(v.EmprestimoContratoPromissoriaCNPJ.as_view()), name='emprestimo_contrato_cnpj+emprestimo_promissoria'),
