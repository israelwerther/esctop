...
class Cliente(models.Model):
    ...
    whatsapp1             = models.BooleanField("Whatsapp", default=False)
    whatsapp2             = models.BooleanField("Whatsapp", default=False)
    ...
    whatsapp1_trabalho    = models.BooleanField("Whatsapp", default=False)
    whatsapp2_trabalho    = models.BooleanField("Whatsapp", default=False)
